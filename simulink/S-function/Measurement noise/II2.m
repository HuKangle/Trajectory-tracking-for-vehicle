function [sys,x0,str,ts] = II2(t,x,u,flag)
%***************************************************************%
    switch flag,
...
sys = [PosX; PosY; PosPsi; Station; PSI; e_psi; e_y; Vy; Beta; yawrate; err; U(2,1)]; %
...
%***************************************************************%  
    ...
    VehStatemeasured.x_dot   = ModelInput(4)/3.6+ ModelInput(42); 
    VehStatemeasured.y_dot   = ModelInput(5)/3.6+ ModelInput(42);    
    VehStatemeasured.phi_dot = (round(10*ModelInput(6))/10)*pi/180+ ModelInput(41);      
    ...
    VehStatemeasured.x_dot_real   = ModelInput(4)/3.6; 
    VehStatemeasured.y_dot_real   = ModelInput(5)/3.6; 
