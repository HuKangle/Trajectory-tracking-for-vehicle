function [sys,x0,str,ts] =TMPC1(t,x,u,flag)
%***************************************************************%
%***************************************************************% 
    switch flag,
...
%     VehiclePara.CarHat = -72000;
%     VehiclePara.CafHat = -77000;
...
%     CostWeights.K2 = K2;
    ...
    RMPC = Tube_MPC828(VehiclePara, MPCParameters, Constraints, CostWeights, StateSpaceModel, Envelope, Vel);
    solution = 0;
    fwa_sol  = 0;
    fwa_e = 0;
