function [sys,x0,str,ts] = HTMPC3(t,x,u,flag)
%***************************************************************%
...
%     VehiclePara.CafHat = -82000;
   [Sl, Ql, Rdun,Rdul, Wshl, dun, dul] = func_CostWeightingRegulation_QuadSlacks_Yalmip(MPCParameters, CostWeights, Constraints);
    ...
    StateSpaceModel.K = K;
%      obj.gcc.k = K;
    RMPC = Tube_MPC_ROLL_824(MPCParameters, Constraints, CostWeights, obj);
    solution = 0;
    fwa_sol  = 0;
    fwa_e = 0;
...
%     fwa_current = fwa_sol;
    inputs   = {err, Ur, fwa_current,alpha(5)};
...
%     K_correct  = StateSpaceModel.gcc.k;
    ...
    %====================================================================%
    Ctrl_SteerSW = 19 * fwa_e*180/pi; % in deg.    
...
% Ctrl_SteerSW; t_Elapsed; PosX; PosY; PosPsi; Station; PSI; e_psi; e_y; cost; LTR_T; LTR; Vy; Beta; yawrate; fwa_sol; fwa_e; err;Ur'; solution; tire_parameter
