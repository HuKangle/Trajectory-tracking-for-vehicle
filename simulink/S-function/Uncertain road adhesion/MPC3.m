...
[y, e] = func_RLSFilter_Calpha_r('initial', 0.95, 10, 10);
    ...
    RMPC = Solver_MPC(VehiclePara, MPCParameters, Constraints, CostWeights, StateSpaceModel, Envelope, Vel);
...
%***************************************************************%  
  g = 9.81;
    ...
    VehStatemeasured.x_dot   = ModelInput(4)/3.6;
    VehStatemeasured.y_dot   = ModelInput(5)/3.6; 
    VehStatemeasured.phi_dot = (round(10*ModelInput(6))/10)*pi/180;   
    VehStatemeasured.beta    = (round(10*ModelInput(7))/10)*pi/180; 
