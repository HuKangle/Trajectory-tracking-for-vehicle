function [sys,x0,str,ts] =TMPC3(t,x,u,flag)
%***************************************************************%
%***************************************************************% 
    switch flag,
...
%         VehiclePara.CarHat = -54000;
%         VehiclePara.CafHat = -58000;
    ...
    Constraints.Robust_constraint = load('E:\carsim\CARSIM2020\Extensions\Simulink\chapter8_rollover_prevention_terrain\DoubleLineShift\TMPC.mat');
%     CostWeights.K2 = K2;
    global RMPC
    global solution
    global fwa_sol
...
%     RMPC = Tube_MPC5(MPCParameters, Constraints, CostWeights);
    ...
    RMPC = Tube_MPC819(VehiclePara, MPCParameters, Constraints, CostWeights, StateSpaceModel, Envelope, Vel);
    solution = 0;
    fwa_sol  = 0;
    fwa_e = 0;
...
%  [StateSpaceModel] = func_RigidbodyModel_FOH_Matrix_ROLL_YALMIP(VehiclePara, MPCParameters, Vel, VehiclePara.CafHat, VehiclePara.CarHat);
%    [StateModel] = func_model(VehiclePara, MPCParameters, Vel, CafHat, CarHat);
%     As       = StateModel.Ad1;
%     Bs1      = StateModel.Bd1;
%     Bs2      = StateModel.Bd2;
%     [K,S,~] = dlqr(As,Bs1,CostWeights.Q_err,CostWeights.Sl);
...
%     inputs   = {x_0, U, fwa_current,As,Bs1,Bs2};
...
% sys = [Ctrl_SteerSW; t_Elapsed; PosX; PosY; PosPsi; Station; PSI; e_psi; e_y; cost; LTR_T; LTR; Vy; Beta; yawrate; fwa_sol; fwa_e; err; ENV; x_nom1; x0 ;fwa_du_sol(1:5)'; Ay; U(2,1:3)'; solution; tire_parameter]; %
