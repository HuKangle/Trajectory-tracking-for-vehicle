...
%    N3 = [h  0];
   ...
   AC   = StateSpaceModel.AC;
   BC1  = StateSpaceModel.BC1;
   BC2  = StateSpaceModel.BC2;
   N_1  = [2*h/(g*Tr)   0   -2*(M*h*h+Ix)/(M*g*Tr)   0];
   N_2  = [0  2*h*Vel/(g*Tr)     0     2*h/Tr ]; %
   H_yzmp_4 = N_1 * AC  + N_2;
   P_yzmp1_4 = N_1 * BC1;
   P_yzmp2_4 = N_1 * BC2;
   Envelope.H_yzmp_4  = H_yzmp_4;
   Envelope.P_yzmp1_4 = P_yzmp1_4;
   Envelope.P_yzmp2_4 = P_yzmp2_4;
