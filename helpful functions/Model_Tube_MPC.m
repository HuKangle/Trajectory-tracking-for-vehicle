...
% Deem Vx as constant
%***************************************************************%
function [StateSpaceModel] = Model_Tube_MPC(VehiclePara, MPCParameters, Vel, Calpha_f, Calpha_r, CostWeights)
...
%     b_w = H * Ts;
    ...
    Eg  = Eg / 1000;
    Ebr = Ebr /1000;
%     [K, P, e] = gcc_terminal(F, G, b_w, Ef, Eg, Q, R);
%         [K, P, e] = gcc(F, G, b_w, Ef, Eg, Q, R);
...
%     StateSpaceModel.gcc.k   = K;
%     StateSpaceModel.gcc.p   = P;
%     StateSpaceModel.gcc.e   = e;
